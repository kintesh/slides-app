# slides-app [![Build Status](https://travis-ci.org/kintesh/slides-app.svg?branch=master)](https://travis-ci.org/kintesh/slides-app)
A tool to make and present HTML5 slides. Supports mathematical equations using MathJax.

This module provides GUI for making slides. A CLI tool can be found at
[https://github.com/kintesh/slides] (https://github.com/kintesh/slides)
